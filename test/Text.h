...
#define TEXT_CONTROL_CHANNEL_5      CC("AI2")
#define TEXT_CONTROL_CHANNEL_6      CC("FLP")
#define TEXT_CONTROL_CHANNEL_7      CC("FL2")
#define TEXT_CONTROL_CHANNEL_8      CC("CH8")
#define TEXT_CONTROL_CHANNEL_9      CC("CH9")

// Output channels (3 letters fixed)
#define TEXT_OUT_CHANNEL_1          CC("SV1")
#define TEXT_OUT_CHANNEL_2          CC("SV2")
#define TEXT_OUT_CHANNEL_3          CC("SV3")
#define TEXT_OUT_CHANNEL_4          CC("SV4")
#define TEXT_OUT_CHANNEL_5          CC("SV5")
#define TEXT_OUT_CHANNEL_6          CC("SV6")
#define TEXT_OUT_CHANNEL_7          CC("SV7")
#define TEXT_OUT_CHANNEL_8          CC("SV8")
#define TEXT_OUT_CHANNEL_9          CC("SV9")
