...
#define TEXT_CONTROL_CH_6           CC("HR2")
#define TEXT_CONTROL_CH_7           CC("WK ")
#define TEXT_CONTROL_CH_8           CC("WK2")
#define TEXT_CONTROL_CH_9           CC("FWk")
#define TEXT_CONTROL_CH_10          CC("K8 ")
#define TEXT_CONTROL_CH_11          CC("K9 ")
...
#define TEXT_WINGMIX_1AIL           CC("1-QR")
#define TEXT_WINGMIX_2AIL           CC("2-QR")
#define TEXT_WINGMIX_DELTA          CC("Delta")
#define TEXT_WINGMIX_VTAIL          CC("VLw")
#define TEXT_WINGMIX_VTAIL2         CC("2Q-VLw")
